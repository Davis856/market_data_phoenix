defmodule MarketDataPhoenixWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(MarketDataPhoenixWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(MarketDataPhoenixWeb.Gettext, "errors", msg, opts)
    end
  end
